...
class StepStateTest(unittest.TestCase):
    ...
    def test_basic_activity(self):
        ...
        self.assertEqual(my_act.schedule_to_start_timeout, '30')
        self.assertEqual(my_act.schedule_to_close_timeout, '300')
        self.assertEqual(my_act.start_to_close_timeout, '300')
